...
<%@ include file="/common/bookClass.jspf" %>
       ...
       <!-- 부트:왼쪽 사이드바 -->
		...
		<table border class="table" style="width:100%" id="mainExp">
			<!-- <tr>
				<th width="100px">1</th>
				<th width="200px">2</th>
				<th width="450px">3</th>
			...
			<tr>
				<td rowspan="8" style="width:50%"><img src="${bookVo.book_img}" style="width:100%" ><!-- "../resources/images/pic/bookp.jpg" --></td>
				<td colspan="3" style="width:50%; color:#5F0E1F; font-size:2.5em; padding-left:2%;">${bookVo.book_name}</td>
				
			</tr>
			<tr>
				<td style="border-right: 0.3% solid gray; padding-left:2%">${bookVo.book_writer}</td>
				<td style="border-right: 0.3% solid gray; padding-left:2%">${bookVo.book_publisher }</td>
				<td style="padding-left:2%">${bookVo.book_published_date }</td>
			</tr>
			<tr>
				<td colspan="4" style="padding-left:2%">***** 9.3 
			...
			<tr>
				<td colspan="2" style="padding-left:2%;">판매가
			...
			<tr>
				<td rowspan="3" style="padding-left:2%; width:100%">통합포인트 :</td>
				<td>[기본적립] ${bookVo.pluspoint() }원 적립(5%)</td>
				
			</tr>
			<tr>
				<td>[추가적립] 5만원 이상 구매 시<br>2천원 추가적립
				<input type="button" value="안내" style="width:30%" id="popupBtn">
			...
			<tr>
				<td style="width:80%">[회원혜택] 실버등급 이상,<br>3만원 이상 구매 시 
				<br>2~4% 추가적립
				<input type="button" value="안내" style="width:30%" id="popupBtn2">
					<div id="plusPopup2">
						<div class="center"> 
							<br>
				...
				<input type="button" value=" 매장별 재고/위치    >" id="storeBtn"
					style="width:100%; height:50%; font-size:1.5em; text-align:center;
					padding-up: 30%;">
				<div id="storeContainer"><%--팝업창 div --%>
						<div id="storeBanner">
							<span>매장별 재고 및 위치</span>
							<span><a href="#" class="close" style="padding-right:5%;">X</a></span>
						</div>
					<br>
		...
		<%-- 	게시글에 작성된 댓글 표시영역
			...
			<div style= "width:100%; "><%--교환/반품/품절 감싼 div --%>
			<table class="table" style= "border:1px solid #DDDDDD;" id="exchange2"><%-- 교환/반품/품절 내용 --%>
				...
				<tr>
					...
					<td class="exchange3" style="padding-left:40px">
						<ul>
