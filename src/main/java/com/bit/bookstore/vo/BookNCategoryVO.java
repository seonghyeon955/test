...
public class BookNCategoryVO {
	...
	public BookNCategoryVO() {
		super();
	}

	

	public BookNCategoryVO(int book_no, int category_no, String book_name, String book_writer, String book_publisher,
			int book_price, int book_saleprice, String book_info, String book_published_date, int book_total_page,
			String book_entered_date, int ebook, int book_isbn, String book_img, String category_code,
			String category_main, String category_name) {
		super();
	...
	public String toString() {
		return "BookNCategoryVO [book_no=" + book_no + ", category_no=" + category_no + ", book_name=" + book_name
				...
				+ ", category_code=" + category_code + ", category_main=" + category_main + ", category_name="
				+ category_name + "]";
	}
