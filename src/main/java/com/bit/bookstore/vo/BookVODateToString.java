...
public class BookVODateToString {
	private int book_no;
	...
	public BookVODateToString() {
		super();
	}

	public BookVODateToString(int book_no, int category_no, String book_name, String book_writer, String book_publisher,
			int book_price, int book_saleprice, String book_info, String book_published_date, int book_total_page,
			String book_entered_date, int ebook, int book_isbn, String book_img) {
		super();
