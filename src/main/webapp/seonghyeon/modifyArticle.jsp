...
<% 
	...
	pageContext.setAttribute("review_no", review_no);
%>  
...
<div class="row">
  ...
  <div class="col-xl-8 col-md-8 mb-8 bg-light">	
	...
	<div id="container">
		...
		<hr>
		<br>
		<form action="${pageContext.request.contextPath }/modifyBoard.do" method=get>
			<table>
				<tr>
					<th width="70">제목</th>
					<td>
						<input type="text" name="review_title" size="30" value="${art.getReview_title() }">
					</td>
				</tr>
				<tr>
					<th>작성자</th>
				...
				<tr>
					<th>내용</th>
					<td>
						<textarea name="review_content" rows="10" cols="100">${art.getReview_content() }</textarea>
					</td>
				</tr>
				<!-- <tr>
					<th>첨부파일</th>
