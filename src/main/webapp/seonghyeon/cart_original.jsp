...
<form action="${pageContext.request.contextPath}/soomin/order/orderStep0.do" method="get">               
              <div class="tab-pane fade show active" id="qwe">
               ...
               <!--  <input type="button" value="바로드림 이동"> -->
                 ...
                 <table border id="sangpumjungbo">
					...
					<tr>
						<td style="padding-up:20px;">
							...
							<div class="delBtn">
							<!-- <input type="button" value="선택삭제" class="selectDelete_btn"> -->
							<!-- <script>
								$(".selectDelete_btn").click(function(){
									...
									if(confirm_val) {
										...
										$.ajax({
											url : "seonghyeon/deleteCart.do",
											type : "post",
											data : { chBox : checkArr },
											success : function(result){
												if(result == 1){
													location.href="seonghyeon/cart.jsp";
												}else {
													alert("삭제실패");
												}
											}
                 ...
                 <br>
                 <!-- <div class="allCheck">
                 <input type="checkbox" id="allCheck" id="allCheck">
                 &nbsp;전체선택&nbsp;&nbsp;
                 </div> -->
	...
	<form action="${pageContext.request.contextPath}/soomin/order/orderStep0.do" method="get"> 
	          <div class="tab-pane fade" id="asd"> 
               ...
               <!--  <input type="button" value="바로드림 이동"> -->
                 ...
                 <table border id="sangpumjungbo">
                 	...
                 	<c:forEach var="quickPickCartList" items="${quickPickCartList }">
					<tr>
						<td style="padding-up:20px;">
							<div class="checkbox"><!-- 개별 체크박스 -->
            ...
            <!-- ******************************************************** -->    
             ...
             <!-- 비회원일때 -->
           <!--  <div class="tab-content"> -->
   <%--  <c:if test="${empty sessionScope.user && cartvo.store_code !='online'}"> --%><!-- 비회원 장바구니 -->
              ...
              <br><br>
                ...
                <script>
                 ...
                 <table border id="sangpumjungbo">
                 	...
                 	<c:forEach var="nonBookVo" items="${nonBookVoList }" ><!--비회원 온라인배송 -->
                 	<c:if test="${ nonBookVo.store_code eq 'online' }">
					<tr>
						<td style="padding-up:20px;">
							<div class="checkbox"><!-- 개별 체크박스 -->
